...
const LoginScreen = () => {
    ...
    const onLoginPress = () => {
        ...
        const user = users.find(user => user.email.toLowerCase() == username.toLowerCase() || user.username.toLowerCase() == username.toLowerCase());
        const result = user ? compareHashedPassword(password, user.password) : false;
