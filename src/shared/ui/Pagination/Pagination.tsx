        ...
        <View style={styles.container}>
            {
                ...
                <View style={styles.pageButtonContainer}>
                    <AppButton text="<" style={styles.pageButton} onPress={() => onPagePress(page - 1)} />
                </View>
            }
            {
                pages.map((i) =>
                    <View style={styles.pageButtonContainer} key={`page-${i}`}>
                        <AppButton style={i == page ? styles.activeButton : styles.pageButton} text={`${i + 1}`} onPress={() => onPagePress(i)} />
                    </View>
                )
            }
